...
<h4 >Copyright © 2018 MediCare.com. All rights reserved.</h4>
  ...
  <script type="text/javascript">
   function display{
     var op1 = document.getElementById("sel1").value();
